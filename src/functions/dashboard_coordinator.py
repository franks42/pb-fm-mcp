...
@api_function(
    protocols=["rest"],
    description="Browser polling endpoint to get current S3 coordinates for dashboard session switching",
)
...
@api_function(
    protocols=["mcp"],
    description="AI function to set new S3 coordinates causing browsers to switch dashboard layouts",
)
...
@api_function(
    protocols=["mcp"],
    description="AI function to instantly switch dashboard to different pre-staged layout variant",
)
async def switch_dashboard_layout(
    session_id: str, layout_variant: str, s3_bucket: str = None
) -> JSONType:
    """
...
@api_function(
    protocols=["mcp"],
    description="AI function to create new pre-staged layout variant in S3 for instant switching",
)
