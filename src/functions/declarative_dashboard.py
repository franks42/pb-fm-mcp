...
@api_function(
    protocols=["mcp"],
    description="Upload HTML/CSS layout declaration to S3 for dashboard initialization",
)
...
@api_function(
    protocols=["mcp"],
    description="Upload Plotly chart declarations to S3 for empty chart generation",
)
async def declare_plotly_charts(
    session_id: str, charts: List[Dict[str, Any]]
) -> JSONType:
    """
...
@api_function(
    protocols=["mcp"],
    description="Upload chart data declarations to S3 for progressive data loading",
)
async def declare_chart_data(
    session_id: str, datasets: List[Dict[str, Any]]
) -> JSONType:
    """
...
@api_function(
    protocols=["mcp"],
    description="Create example dashboard demonstrating declarative dashboard system",
)
async def create_example_dashboard(
    session_id: str, wallet_address: str = "demo_wallet"
) -> JSONType:
    """
    ...
    try:
        ...
        data_result = await declare_chart_data(session_id=session_id, datasets=datasets)
