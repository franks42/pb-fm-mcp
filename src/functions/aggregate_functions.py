...
try:
    ...
    from .figure_markets_functions import (
        fetch_current_fm_data, fetch_current_fm_account_balance_data, fetch_current_fm_account_info,
        fetch_last_crypto_token_price, fetch_figure_markets_assets_info
    )
