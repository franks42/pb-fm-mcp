...
@api_function(
    protocols=["mcp"],
    description="Analyze MCP request context to identify potential unique identifiers for AI instances",
)
async def analyze_mcp_request_context() -> JSONType:
    ...
    try:
        ...
        return {"success": False, "error": f"Debug analysis failed: {str(e)}"}


@api_function(
    protocols=["mcp"],
    description="Create test dashboard while attempting to capture AI instance information for debugging",
)
async def create_debug_dashboard(
    ...
    try:
        ...
        return {"success": False, "error": f"Debug dashboard creation failed: {str(e)}"}


@api_function(
    protocols=["mcp"],
    description="Test session persistence mechanisms to identify same AI instance across MCP calls",
)
async def test_session_persistence(test_value: str = "session_test") -> JSONType:
    """
    ...
    try:
        ...
        return {"success": False, "error": f"Session persistence test failed: {str(e)}"}
